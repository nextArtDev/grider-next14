  ...
  return (
    <section className="flex flex-col mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
      ...
      <footer className="pb-8 " aria-labelledby="footer-heading">
        ...
        {/* </div> */}
        <div className="fixed bottom-0 left-0 flex h-24 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none"></div>
      </footer>
    </section>
  )
}
