...
const ContributorItem: FC<ContributorItemProps> = ({ contributor }) => {
  return (
    <CardContainer className="inter-var">
      <CardBody className="flex-start bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[15rem] h-96 rounded-xl p-6 border  ">
        <CardItem
          translateZ="50"
